...
from apps.auth import models as auth_app
    ...
    if UserModel in created_models and kwargs.get('interactive', True):
        ...
        while 1:
            if confirm not in ('yes', 'no'):
                ...
                continue
            if confirm == 'yes':
                call_command("superuser", interactive=True, database=db)
            break
...
signals.post_syncdb.connect(create_permissions, dispatch_uid="apps.auth.management.create_permissions")
#signals.post_syncdb.connect(create_superuser, sender=auth_app, dispatch_uid="auth.auth.management.create_superuser")
